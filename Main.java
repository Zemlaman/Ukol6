//shoutout robíkovi za nervy a za pomoc🥰
...
public class Main {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (!doesCarExist(carId, cars)) {
                ...
                Car actCar = cars.get(carId);
                actCar.setWeight(Double.parseDouble(input[1]));
            }
        }
    ...
    public static Car getCarWeigth(int id, ArrayList<Car> cars) {
        if (cars.size() <= id || id < 0) {
            System.out.println("Auto nebylo nalezeno ");
            return null;
        }
